...
export default function RecordCreate(props) {
  ...
  return (
    ...
    <div className='Font-Verdana-Small'>
      ...
      <div onClick={toggleAccordion}><img src={spacer}/><a data-tooltip-id="insert" data-tooltip-content="Insert"><GiHummingbird style={{color: '#1994AD', fontSize: '35px', cursor: 'pointer' }}/></a><b>Add a Record</b><img src={spacer}/><a data-tooltip-id="insert" data-tooltip-content="Insert"></a></div>
      {isExpanded && (
        <div>
        <div>
