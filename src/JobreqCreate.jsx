        ...
        <div>
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <img alt="1" src={spacer}/><img alt="1" src={spacer}/>Location:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '250px' }} placeholder="Required" type="text" value={location} onChange={(event) => setLocation(event.target.value)} required/>
              <div>&nbsp;</div>
              <img alt="1" src={spacer}/><img alt="1" src={spacer}/>Recruiter's Name:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '200px' }} placeholder="Required" type="text" value={recruitername} onChange={(event) => setRecruitername(event.target.value)} required/>
              <img alt="1" src={spacer}/>Recruiter's eMail Address:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '250px' }} placeholder="Required" type="text" value={recruiteremail} onChange={(event) => setRecruiteremail(event.target.value)} required/>
