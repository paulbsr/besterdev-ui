...
export default function BreakingNewsAPI() {
    ...
    useEffect(() => {
        fetchDataAPI();
    }, [searchPhrase]); // Trigger fetchDataAPI when searchPhrase changes
    ...
    const fetchDataAPI = async () => {
        ...
        console.log('BreakingNewsAPI', dayOne, dayTwo, searchPhrase)
        ...
        try {
            ...
            console.log('Jou POST na Heroku met:', serializedData);
        } catch (error) {
