        ...
        <div>
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='Font-Verdana-Small-Postgres'>
                <div><img alt="1" src={spacer} /><img alt="1" src={spacer} />Company Name:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '230px' }} placeholder="Required" type="text" value={empname} onChange={(event) => setEmpname(event.target.value)} required /><img alt="1" src={spacer} /><img alt="1" src={spacer} />&nbsp;Comment:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '675px' }} type="text" value={empcomment} onChange={(event) => setEmpcomment(event.target.value)} /></div>
                <div>&nbsp;</div>
