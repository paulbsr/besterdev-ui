        ...
        <div>
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='Font-Verdana-Small-Postgres'>
                <div><img alt="1" src={spacer} /><img alt="1" src={spacer} />Company Name:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '160px' }} placeholder="Required" type="text" value={empname} onChange={(event) => setEmpname(event.target.value)} required /><img alt="1" src={spacer} /><img alt="1" src={spacer} /><img alt="1" src={spacer} /><img alt="1" src={spacer} />&nbsp;Comment:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '675px' }} type="text" value={empcomment} onChange={(event) => setEmpcomment(event.target.value)} /></div>
                <div>&nbsp;</div>
                <div><img alt="1" src={spacer} /><img alt="1" src={spacer} />Contact's First Name:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '200px' }} placeholder="Required" type="text" value={empcontactfn} onChange={(event) => setEmpcontactfn(event.target.value)} required />
                  ...
                  <img alt="1" src={spacer} /><img alt="1" src={spacer} />Contact's Mobile Number:&nbsp;<input style={{ height: '27.5px', border: '1.25px solid #c4c4c4', borderRadius: '4px', padding: 0, paddingLeft: '10px', width: '200px' }} placeholder="Required" type="text" value={empcontactnum} onChange={(event) => setEmpcontactnum(event.target.value)} required /></div>
                <div>&nbsp;</div>
                <div><img alt="1" src={spacer} />&nbsp; &nbsp; &nbsp;<button className="Font-Verdana-Small-Postgres" type="submit" style={{ marginLeft: '10px', height: '27.5px', border: '1px solid #336791', borderRadius: '5px', backgroundColor: '#FFFFFF', color: '#336791', cursor: 'pointer' }}>Add Employer/Customer</button></div>
              </div>
            </form>
          </div>
        </div>)}
