...
// import React, { useEffect, useState } from "react";
// import { FaTimes } from "react-icons/fa";
// import { TbMessageChatbot, TbCalendarEvent } from "react-icons/tb";
// import { ToastContainer, toast } from "react-toastify";
// import "react-toastify/dist/ReactToastify.css";
// import DutchLanguage_AI_Response from "./DutchLanguage_AI_Response";
// import { DutchLanguage_AI_Evaluator_Chatbot } from "./DutchLanguage_AI_Evaluator_Chatbot";
...
// // Individual TimeGroup component
...
// // DateGroup component (used for grouping entries per date)
// const DateGroup = ({ dateKey, entries }) => {
//   return (
//     <div style={{ marginBottom: "10px" }}>
//       <div style={{ fontWeight: "bold", fontFamily: "Segoe UI", fontSize: "12pt", color: "#FF4F00" }}>
//         {dateKey}
//       </div>
//       <div style={{ marginLeft: "15px", marginTop: "5px" }}>
//         {entries
...
//   const [recentData, setRecentData] = useState(null);
//   const [allEntries, setAllEntries] = useState([]);
//   const [showPastEntries, setShowPastEntries] = useState(false); // NEW: toggle past entries
...
//       {/* SINGLE ICON TO TOGGLE ALL PAST ENTRIES */}
//       <div style={{ marginTop: "12px", cursor: "pointer", display: "flex", alignItems: "center" }} onClick={() => setShowPastEntries(!showPastEntries)}>
//         <TbCalendarEvent style={{ fontSize: "28px", color: "#FF4F00", marginRight: "8px" }} />
//         <span style={{ fontSize: "14pt", fontWeight: "bold" }}>{showPastEntries ? "Verberg eerdere chatberichten" : "Bekijk eerdere chatberichten"}</span>
//       </div>
