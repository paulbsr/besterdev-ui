    ...
    <div style={{ marginBottom: "6px" }}>
      ...
      {expanded && (
        ...
        >
          ...
          {/* Scores line */}
          <div style={{ color: "#909090", marginBottom: "6px" }}>
            Grammar {item.scoreGrammar} • Vocab {item.scoreVocabulary} • Spelling {item.scoreSpelling} • Comprehensibility {item.scoreComprehensibility} • Word Order {item.scoreWordorder}
          </div>
