...
import { BiLogoFirebase, BiLogoPostgresql, BiLogoHeroku, BiLogoGithub } from "react-icons/bi";
...
import { useNavigate } from 'react-router-dom'; 
  ...
  return (
    ...
    <div className="banner-light" >
      ...
      <a data-tooltip-id="insert" data-tooltip-content="Statistics" href=""><BsFileBarGraph style={{ color: '#336791', fontSize: '28px', cursor: 'pointer' }} /></a>&nbsp; &nbsp;
    </div>
  );
};
