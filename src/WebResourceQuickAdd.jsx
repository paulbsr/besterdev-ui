        ...
        <div className='Font-Verdana-QuickAdd'>&nbsp;
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='Font-Verdana-QuickAdd'>
                    ...
                    <button className="Font-Verdana-Small-Postgres" type="submit" style={{ marginLeft: '10px', height: '19.5px', border: '1px solid #c4c4c4', borderRadius: '5px', backgroundColor: '#ffffff', color: 'grey', cursor: 'pointer' }}>Add</button>
                </div>
            </form>
        </div>
    );
