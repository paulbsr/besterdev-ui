...
export const CyclopediaAPIProvider = ({ children }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // const response = await OAuth2APIClient.get('https://besterdev-api-13a0246c9cf2.herokuapp.com/api/v1/cyclopedia/random20');
        const response = await OAuth2APIClient.get('https://besterdev-api-13a0246c9cf2.herokuapp.com/api/v1/cyclopedia');
        // const response = await OAuth2APIClient.get('http://localhost:8000/api/v1/cyclopedia');
        // const response = await OAuth2APIClient.get('http://localhost:8000/api/v1/cyclopedia/random20');
